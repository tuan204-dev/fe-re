...
const ChatInput: FC<ChatInputProps> = ({ recruitingId, refreshMessages }) => {
    ...
    return (
        <div className="p-4 border-t border-gray-200 max-w-[900px] mx-auto w-full">
            <div className="flex items-center space-x-2">
                ...
                <button onClick={handleSend} disabled={!value.trim()} className="px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    Send
                </button>
            </div>
        </div>
