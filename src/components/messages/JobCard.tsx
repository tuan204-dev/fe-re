...
const JobCard: FC<JobCardProps> = ({ job, onClick }) => {
    ...
    return (
        <div onClick={handleClick} className={cn("job-card bg-white p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-blue-50 transition-colors duration-200", {
