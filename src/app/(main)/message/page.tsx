    ...
    return (
        <div>
            ...
            <div className="flex h-screen overflow-hidden">
                {/* Left Sidebar */}
                <div id="sidebar" className="sidebar bg-white w-80 border-r border-gray-200 flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto scrollbar-hide p-2">
                        <div className="space-y-2">
                            {jobs.map((job) => (
                                <JobCard onClick={handleClickJob} key={job._id} job={job} />
                            ))}
                        </div>
                    </div>
                    {/* Add New Job Button */}
