    ...
    if (isSended) {
        return (
            <div className="flex flex-col items-center justify-center gap-y-3 min-h-screen">
                ...
                <p className="text-gray-500">Please check your email to complete the registration process.</p>
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-y-3 min-h-screen">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-y-4 w-[300px]">
                ...
                <Link href={'/auth/login'} className="text-xs text-center text-blue-500 hover:underline">
